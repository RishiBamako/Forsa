...
public class RoundedCornersTransformation_Picasso  implements Transformation {
    ...
    public RoundedCornersTransformation_Picasso(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public RoundedCornersTransformation_Picasso(int radius, int margin, CornerType cornerType) {
        mRadius = radius;
        mDiameter = radius * 2;
        mMargin = margin;
