...
public class SplashActivity extends AppCompatActivity {
    ...
    @BindingAdapter("app:bindSpinnerAdapter")
    ...
    @BindingAdapter("app:genderSpinnerAdapter")
    ...
    @BindingAdapter("app:EditPrd_CategotyAdapter")
    ...
    @BindingAdapter("app:EditPrd_SubCategotyAdapter")
    ...
    @BindingAdapter("app:bindSpinnerAdapter_BigFont")
    ...
    @BindingAdapter("app:loadImageBitmap")
    ...
    @BindingAdapter("app:loadImageCircle")
    ...
    //BINDING_FUNCTION
    @BindingAdapter("app:videoFromPath")
    ...
    @BindingAdapter("app:profileCircle")
    ...
    @BindingAdapter("app:isLikedOrNot")
    ...
    @BindingAdapter("app:switchButtonBinder")
    ...
    @BindingAdapter("app:addressBinder")
    ...
    @BindingAdapter("app:followerStatus")
    ...
    @BindingAdapter("app:isWishedOrNot")
    ...
    @BindingAdapter("app:nameManipulation")
    ...
    @BindingAdapter("app:htmlTextManipulator")
    ...
    @BindingAdapter("app:dateManipulation")
    ...
    @BindingAdapter("app:manipulateCheckBox")
    ...
    @BindingAdapter("app:followOrUnfollow")
    ...
    @BindingAdapter("app:isUserVerified")
    ...
    @BindingAdapter("app:locationFromLatLong")
    ...
    @BindingAdapter("app:dateOfBirth")
    ...
    @BindingAdapter("app:ratingManipulate")
    ...
    @BindingAdapter("app:manipulateGender")
    ...
    @BindingAdapter("app:imageWithCustomRadius")
    ...
    @BindingAdapter("app:imageWithCustomRadius_bartering")
    ...
    @BindingAdapter("app:imageWithCustomRadius_Bitmap")
    ...
    @BindingAdapter("app:imageWithCustomRadius_Bitmap_Overview")
    ...
    @BindingAdapter("app:imageWithCustomRadius_URL_Overview")
    ...
    @BindingAdapter("app:mailManipulate")
    ...
    @BindingAdapter("app:callToSeller")
    ...
    @BindingAdapter("app:openWhatsApp")
    ...
    @BindingAdapter("app:imageWithCustomRadiusBitmap")
    ...
    @BindingAdapter("app:radiusBitmap_ImageVideo")
