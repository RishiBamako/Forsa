...
public class ChatScreenActivity extends AppCompactActivity implements ClickListener, Observer<Object> {
    ...
    public void onChanged(Object o) {
        ...
        if (resultData.getTag().equals("CHANGE_PASSWORD")) {
            ...
            if (comman_serviceModel.isStatus().equals("true")) {
                Intent intent = new Intent(ChatScreenActivity.this, SignInActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
            AlphaHolder.customToast(ChatScreenActivity.this, comman_serviceModel.getMessage());
        }
    }
    ...
    private void changePassword() {
        ...
        paramMap.put("token", SharedPreferences_Util.getToken(ChatScreenActivity.this));

        viewModel = ViewModelProviders.of(this, vmFactory).get(ApiCaller.class);
        viewModel.loadData("CHANGE_PASSWORD", paramMap, true, ChatScreenActivity.this);
